<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Christoc.Modules.DnnTaskManagerDal2.Edit" %>
...
<div class="dnnForm dnnEditBasicSettings" id="dnnEditBasicSettings">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            <dnn:label ID="lblTargetCompletionDate" runat="server" />
            <asp:TextBox ID="txtTargetCompletionDate" runat="server" />
        </div>

        <div class="dnnFormItem">
            <dnn:label ID="lblCompletionDate" runat="server" />
